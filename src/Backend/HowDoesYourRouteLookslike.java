...
// Option sicher einlesen und Zeilenende konsumieren
            ...
            switch (iwanToseeinside) {
                case 1:
                    ...
                    if (cities.containsElement(Element)) {
                        System.out.println("Gefunden: " + Element);
                    } else {
                ...
                case 2:
                    System.out.println("Bitte Element eingeben:");
                    Element = scanner.nextLine().trim();
                    if (cities.removeElement(Element)) {
                        System.out.println("Gelöscht: " + Element);
                    } else {
                        System.out.println("Konnte Element nicht löschen.");
                    }
                    break;
                case 3:
